...
class TestDot(TestCase):
    ...
    def do_dot(self, v0, v1, l, v0_stride, v1_stride, result):
        ...
        t.input_scalar("a2", l)
        t.input_scalar("a3", v0_stride)
        t.input_scalar("a4", v1_stride)
...
class TestReadMatrix(TestCase):
    ...
    def do_read_matrix(self, filename="", result=[], fail='', code=0):
        t = AssemblyTest(self, "read_matrix.s")
        # load address to the name of the input file into register a0
        # 模版代码与文档的变量要求似乎有出入，就以模版为准吧
    ...
    def test_simple(self):
        self.do_read_matrix(filename="inputs/test_read_matrix/test_input.bin", result=list(range(1, 10)))
